...
mental_health_score = st.slider("Mental Health Score", 0.0, 100.0, 25.0) 

ptj_encoded = 1 if part_time_job == "Yes" else 0 

if st.button("Predict Exam Score"): 
    input_data = np.array([[study_hours, self_study_hours, social_media_hours,
                            gaming_hours, sleep_hours, ptj_encoded,
